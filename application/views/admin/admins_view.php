...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="<?php echo base_url().'arthouseadmin/edit/'.$row->id.'/admins'; ?>"><span class="fa fa-cogs"></span></a></td>
        <td>
            <a href="#" id="<?php echo $row->id; ?>" class="delete_data" style="color:#e74c3c;"><span class="fa fa-trash"></span></a>
        <input type="hidden" id="wher" value="admins">
        </td>
    </tr>
      <?php $x++;}}else{
              ?>
      <h5>There Is No Clients To Show.</h5>
      <?php
          } ?>
  </tbody>
</table>

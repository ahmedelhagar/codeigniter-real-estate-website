...
<div class="col-lg-12 col-md-12 col-sm-12 btnss">
    <a href="<?php echo base_url().'arthouseadmin/addcareer'; ?>" class="btn btn-primary add">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row"><?php echo $x; ?></th>
        ...
        <?php
              $num = $this->main_model->getByDataw('items','(state = 13 AND c_id = '.$row->id.')','count');
                if($num == ''){$num=0;}
              ?>
      ...
      <?php $x++;}}else{
              ?>
      <h5>There Is No Career To Show.</h5>
      <?php
          } ?>
  </tbody>
</table>

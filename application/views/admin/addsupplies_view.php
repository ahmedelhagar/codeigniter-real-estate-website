...
<div class="col-lg-12 col-md-12 col-sm-12 btnss">
    ...
    if($this->uri->segment(2) == 'edit' OR $this->uri->segment(2) == 'editsuppliesCheck'){
        $check='arthouseadmin/editsuppliesCheck/'.$this->uri->segment(3);
    }else{
        $check='arthouseadmin/addsuppliesCheck/';
    }
